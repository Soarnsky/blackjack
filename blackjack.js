...
for (j = 0; j < 2; j++) {
  ...
  $('#cards .hand').append('<li><div class="card rank-' + C.model.cardArray[j].rank + ' ' + C.model.cardArray[j].suit + '><span class="rank">' + C.model.cardArray[j].rank + '</span><span class="suit">&' + C.model.cardArray[j].suit + ';</span></div></li>');
}
